                                ...
                                <table class="table table-condensed table-trans">
                                    <tr>
                                        <td class="text-lg" style="width: 40px">
                                            <span class="badge badge-purple" style="background-color: {{ $colors[0] }}" id="member-male">0</span>
                                        </td>
                                        <td>Male</td>
                                    </tr>
                                    <tr>
                                        <td class="text-lg">
                                            <span class="badge badge-dark" style="background-color: {{ $colors[1] }}" id="member-female">0</span>
                                        </td>
                                        <td>Female</td>
                                    </tr>
                                    <hr>
                                    <tr>
                                        <td>
                                            <div class="text-sm">
                                                <p class="text-5x text-thin text-main mar-no"><span class="badge badge-primary" id="member-total">N0</span></p>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <div class="row mar-top">
                            <div class="col">
                                <table class="table table-condensed table-trans">
                                    ...
                                    <tr>
                                        <td class="text-lg" style="width: 40px"><span style="background-color: {{ $colors[$i] }}" class="badge badge-purple" id="collection-{{ $type->name }}">N0</span></td>
                                        ...
                                        <td>
                                            <div class="text-sm">
                                                <p class="text-5x text-thin text-main mar-no">
                                                    <span class="badge badge-primary" id="collection-total">N0</span>
                                                </p>
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-{{ $isAdmin ? '4' : '6' }}">
                                ...
                                <select id="m-i" required style="outline:none;" name="range" class="selectpicker col-md-12 nav nav-pills ranges" data-style="btn-primary">
                                    ...
                                    @for ($i = 1; $i < 13; $i++) <option value="{{ $i }}">Last{{ $i }} Months</option>
                                        @endfor
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mar-top">
                            <div class="col">
                                <table class="table table-condensed table-trans">
                                    <tr>
                                        <td class="text-lg" style="width: 40px">
                                            <span class="badge badge-purple" style="background-color: {{ $colors[0] }}" id="attendance-male">0</span>
                                        </td>
                                        <td>Male</td>
                                    </tr>
                                    <tr>
                                        <td class="text-lg">
                                            <span class="badge badge-dark" style="background-color: {{ $colors[1] }}" id="attendance-female">0</span>
                                        </td>
                                        <td>Female</td>
                                    </tr>
                                    <tr>
                                        <td class="text-lg">
                                            <span class="badge badge-danger" style="background-color: {{ $colors[2] }}" id="attendance-children">0</span>
                                        </td>
                                        <td>Children</td>
                                    </tr>
                                    <hr>
                                    <tr>
                                        <td>
                                            <div class="text-sm">
                                                <p class="text-5x text-thin text-main mar-no"><span class="badge badge-primary" id="attendance-total">N0</span>
                                                </p>
                                            </div>
                                        </td>
                                    </tr>
            ...
            <div class="col-md-6">
                <div class="panel">
                    <div class="panel-heading">
                        <!--body text-center"-->
                        <h3 class="panel-title"><strong>Wedding Anniversarie(s) For <?php echo date('F Y');
                                                                                    $i = 1; ?></strong> </h3>
                            ...
                            <table id="anniversaries" class="table table-vcenter mar-top">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><a class="btn-link" href="{{ $member->profile() }}">{{ ucwords($member->getFullname()) }}</a>
                                        </td>
                                        ...
                                        <td class="text-center"><span class="label label-table label-info">{{ ucwords($member->position) }}</span>
                                        </td>
                                        <td class="text-center">
                                            <div class="btn-group">
        ...
        <div class="panel">
            <div class="panel-body">
                <div class="row mar-top">
                    <div class="col-md-3">
                        <div class="pad-all text-center">
                            <span class="pad-ver text-main text-sm text-uppercase text-bold">Total Due Collections
                                Commission</span>
                            <p class="text-sm">{{ date('dS F Y', strtotime(NOW())) }}</p>
                            <p class="text-2x text-main"><span id="due-commission">0</span> </p>
                            <a href="{{ route('branch.invoice') }}" class="btn btn-block btn-success mar-top">Pay
                                Now</a>
                        </div>
            ...
            <div class="col-md-6">
                <div class="panel">
                    ...
                    <div class="panel-body bord-btm">
                        ...
                        <a href="#" class="task-footer">
                            <span class="box-inline">
                                <label class="label label-warning"><i class="icofont-location-arrow"></i>
                                    {{ $event->location }}</label>
                                <label class="label label-danger"><i class="icofont-user"></i>
                                    {{ ucwords($event->by_who) }}</label>
                                <label class="label label-primary"><i class="icofont-stop-watch"></i>
                                    {{ $event->date }}</label>
                                <label class="label label-info"><i class="icofont-wall-clock icon-fw text-main"></i>
                                    {{ $event->time }}</label>
                    ...
                    <div class="panel-footer text-center">
                        ...
                        @if (count($eventss) < 1) <p class="text-danger"> No Event </p>
                            @endif
                            <button onclick="window.location.replace(``)" class="btn btn-sm btn-primary"><i class="icofont icofont-plus m-r-0"></i>
                            </button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body bord-btm">
                        ...
                        <a href="#" class="task-footer">
                            <span class="box-inline">
                                <label class="label label-warning">From <i class="icofont-location-arrow"></i>
                                    {{ $event->branchname }}</label>
                    ...
                    @endif
                    <div class="panel-footer text-center">
                        @if (count($eventsall) < 1) <p class="text-danger"> No New Announcement </p>
                            @endif
...
<script>
    ...
    $(document).ready(() => {
        ...
        $.ajax({
                url: "{{ route('member.reg.stats') }}"
            })
            .done((res) => {
                members = setPeriod(res, {
                    male: 0,
                    female: 0,
                    total: 0
                }, ["male", "female"])
        ...
        $.ajax({
                url: "{{ route('attendance.stats') }}"
            })
            .done((res) => {
                attendance = setPeriod(res, {
                    male: 0,
                    female: 0,
                    children: 0,
                    total: 0
        ...
        $('#order-table').DataTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    name: 'payed_at',
                    render: (data) => (`${data.payed_at ? data.payed_at : data.created_at}`)
                },
                {
                    title: 'Amount',
                    data: 'amount',
                ...
                },
                {
                    ...
                    data: 'status',
                    name: 'status',
                    render: (data) => (`<td class="text-center">
        <div class="label label-table label-${data === 'success' ? 'success' : data === 'pending' ? 'warning' : 'danger'}">${data === 'success' ? 'Paid' : data }</div>
      </td>`),
                },
                {
                    title: 'Reference',
