                                ...
                                <div class="col">
                                    <table class="table table-condensed table-trans">
                                        <tr>
                                            <td class="text-lg" style="width: 40px">
                                                <span class="badge badge-purple"
                                                    style="background-color: {{ $colors[0] }}" id="member-male">0</span>
                                            </td>
                                            <td>Male</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="text-sm">
                                                    <p class="text-5x text-thin text-main mar-no"><span
                                                            class="badge badge-primary" id="member-total">N0</span></p>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <div class="col">
                                    <table class="table table-condensed table-trans">
                                        ...
                                        @foreach ($c_types as $type)
                                            <tr>
                                                <td class="text-lg" style="width: 40px"><span
                                                        style="background-color: {{ $colors[$i] }}"
                                                        class="badge badge-purple"
                                                        id="collection-{{ $type->name }}">N0</span></td>
                                    ...
                                    <table class="table table-condensed table-trans">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="text-sm">
                                                    <p class="text-5x text-thin text-main mar-no"><span
                                                            class="badge badge-primary" id="attendance-total">N0</span>
                                                    </p>
                                                </div>
                                            </td>
                                        </tr>
                                ...
                                <a href="#" class="task-footer">
                                    <span class="box-inline">
                                        ...
                                        <label class="label label-info"><i
                                                class="icofont-wall-clock icon-fw text-main"></i>
                                            {{ $event->time }}</label>
                ...
                <div class="col-md-6">
                    ...
                    <div class="panel">
                            ...
                            @foreach ($eventsall as $event)
                                ...
                                @if ($event->start_date >= now())
                                    <div class="panel-body bord-btm">
                                        ...
                                        <a href="#" class="task-footer">
                                            <span class="box-inline">
                                                <label class="label label-warning">From <i
                        ...
                        <div class="panel-footer text-center">
                            ...
                            @endif
                            <button onclick="window.location.replace(`{{ route('notification') }}`)"
