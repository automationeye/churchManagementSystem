...
<?php
        ...
        $leave = "SELECT * FROM member_leave WHERE email = '$_SESSION[email_emp]' ";
        ...
        $check_leave = "SELECT * FROM member_leave WHERE email = '$_SESSION[email_emp]' ";
    ...
    // for next leave date
    $check_ = "SELECT * FROM member_leave WHERE email = '$_SESSION[email_emp]' ORDER BY start_date ASC ";
...
<div class="container">
    ...
    <div class="row mt-5">
        ...
        <div class="col-4">
            <div class="card shadow " style="width: 18rem;">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item text-center"> <b>members</b>  </li>
                    <li class="list-group-item">Total Employees : <?php echo mysqli_num_rows($total_member); ?></li>
